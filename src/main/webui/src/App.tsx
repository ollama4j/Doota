    ...
    <div className="app-container">
      <div className="sidebar">
        <div
          ...
          title="Doota (pronounced Dhoo-tha / Dhūta / Dhootha) comes from the Sanskrit and Kannada word दूत / ದೂತ, meaning messenger, envoy, or agent — someone that carries information, executes tasks, and acts on behalf of another."
        >
